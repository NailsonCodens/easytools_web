...
const Renterules = ({history}) => {
  ...
  useSelector(state => state.rentalinfo);

  let values = queryString.parse(useLocation().search);

  var period = moment.preciseDiff(values.init, values.finish, true);

  console.log(period)
  //o box rental precisa virar um componente pq vai ser usado em 2 páginas
